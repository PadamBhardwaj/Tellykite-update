...
const { getCustomer, loginCustomer, logout, registercustomer, addtellyaccount, resetPassword, forgotPassword, registercustomerreseller, updatePasswordByCustomer } = require("../controllers/customerController")
...
router.route("/customer/updatepassword").post(isAuthenticatedCustomer, updatePasswordByCustomer)
