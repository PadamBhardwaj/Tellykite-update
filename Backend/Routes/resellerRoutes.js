...
const { loginReseller, logout, getReseller, getCustomersOfReseller, registerreseller, forgotPassword, resetPassword, updatePasswordByReseller } = require("../controllers/resellerController")
...
router.route("/reseller/updatepassword").post(isAuthenticatedReseller, updatePasswordByReseller)
